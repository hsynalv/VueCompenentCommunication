...
import {eventBus} from "../main";
  ...
  export default {
    props : {
      //name : [String,Array] // Burada validation yaptık ya string ya array türünde değer gelecek anlamı taşır.
      name : {
        type : String,
        //required : true,
        default : "hhsynalv.com"
      },
      age : String
    },
    methods : {
      ...
      sendToParent(){
        this.$emit("data","beyazskorsky") // veri yaymak için kullanılır.
      }
    },
    created(){
